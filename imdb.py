...
for key in x :
    genre = []
    for each_genre in  key['genre'] :
        genre.append(each_genre.strip( ))
    #print genre
    genre = ','.join(genre)
    #print genre
    print "INSERT INTO `imdb_movie`.`movies` (`movie_id`, `movie_name`, `movie_director`, `movie_99_popularity`, `movie_genre`, `movie_imdb_score`) VALUES (NULL, '"+str(key['name'])+"', '"+str(key['director'])+"', '"+str(key['99popularity'])+"', '"+str(genre)+"', '"+str(key['imdb_score'])+"');"
